...
namespace TaskAtlasNamespace
{
    ...
    public class Landmark
    {
        ...
        public void UpdateProgress(TMP_FontAsset stickyFont, bool forceRefresh=false)
        {
            ...
            if (rt == null) rt = new RenderTexture(512, 512, 1, RenderTextureFormat.Default); //(RenderTexture)Type.GetType("TaskAtlasNamespace.Core, Assembly-CSharp-Editor").GetField("rtStickyText").GetValue(null);
